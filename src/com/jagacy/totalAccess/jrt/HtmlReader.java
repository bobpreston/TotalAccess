...
public class HtmlReader implements AwkReader {
    ...
    public HtmlReader(String fileName, VariableManager vm, boolean isFromFileList) throws IOException {
        ...
        if (!(new File(fileName).exists())) {
            ...
            HtmlExtension.open(myIn, vm, myContext);
        } else {
            HtmlExtension.open(fileName, vm, myContext);
        }
    }

    public HtmlReader(InputStream in, VariableManager vm) throws IOException {
...
//        myIn = in;
        myVm = vm;
        HtmlExtension.open(in, vm, myContext);
    }
