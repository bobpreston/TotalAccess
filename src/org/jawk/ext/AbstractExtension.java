...
public abstract class AbstractExtension implements JawkExtension {
	 ...
	 */
	// RMP
	protected static void checkNumArgs(Object[] arr, int expectedNum, String keyword) {
		...
		if (arr.length != expectedNum) {
		    // RMP
			throw new IllegalAwkArgumentException(keyword, "Expecting " + expectedNum + " arg(s), got " 
			    + arr.length);
		}
	}
